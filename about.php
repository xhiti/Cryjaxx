...
<main>
    <section class="razo-latest-news-area bg-overlay bg-img jarallax" style="background-image: url(assets/img/cryjaxx_about_first.jpg); height: 500px;"></section>
    <div class="wantToWork-area w-padding" style="padding-top: 0!important; padding-bottom: 0!important;">
        <section class="uza-news-area section-padding-80 about-section" id="about" style="padding-bottom: 0!important;">
            <div class="container">
                <div class="row">
                    <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                        <div class="inner-column">
                            <div class="sec-title">
                                <span class="title">About Cryjaxx</span>
                                <h2>Starting from the bottom <br>now we way up!</h2>
                            </div>
                            <div class="text">
                                Hailing from Tirana – Albania, <b>Mario &amp; Serafin</b>, better known as <b>CryJaxx</b> are one of the most promising DJ &amp; Producer Duo in their country. They have more than 6 years of experience in Music Production. Excelled in EDM and working on different genres, they have managed to achieve recognition and success through their remixes and original tracks getting tens of millions of streams and a worldwide audience. CryJaxx also were featured on worldwide leading music channels such as <b>Trap Nation, Bass Nation, Trap City</b> and the Indie label <b>Tribal Trap</b>. Counting more than 60 tracks released, Mario and Serafin have worked with labels from <b>USA, UK, Netherlands, Germany, Canada </b>etc. In 2018 they gathered more than <b>2 Million streams</b> on Spotify and a total of <b>10 Million views</b> on YouTube. In 2019 CryJaxx have already released 10 tracks and have a lot more set to release by this year. They also performed on the biggest festival in Albania – <b>“Colour Day Festival”</b> in 18th of May. The young boys promise to deliver nothing but quality music and crate new experiences. Make sure to follow their journey and keep an eye on their upcoming shows!</div>
                            <div class="btn-box">
                    ...
                    <!-- Image Column -->
                    <div class="image-column col-lg-6 col-md-12 col-sm-12" style="padding-bottom: 100px!important;">
                        <div class="inner-column wow fadeInLeft">
                            <figure class="image-1"><a href="#" class="lightbox-image" data-fancybox="images"><img src="assets/img/cryjaxx_about.jpg" class="about_us_1" alt=""></a></figure><br><br>
                        </div>
                        <div class="col-12">
                            <div class="effects">
                                <div class="effect aemilius">
                                    <div class="buttons">
                                        <a href="https://www.facebook.com/CryJaxx" target="_blank" class="fb" title="Join us on Facebook"><i class="fab fa-facebook" aria-hidden="true"></i></a>
                                        <a href="https://twitter.com/CryJaxx" target="_blank"" class="tw" title="Join us on Twitter"><i class="fab fa-twitter" aria-hidden="true"></i></a>
                                        <a href="mailto:contact@cryjaxx.com" class="g-plus" title="Join us on Google+"><i class="fab fa-google-plus" aria-hidden="true"></i></a>
                                        <a href="https://www.instagram.com/CryJaxx" target="_blank" class="insta" title="Join us on Instagram"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                                        <a href="https://www.youtube.com/c/CryJaxx" target="_blank" class="dribbble" title="Join us on Youtube"><i class="fab fa-youtube" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
