    ...
    if (isset($_POST["newsletter_button"])){
        ...
        if (!isset($email)){
            ...
            if ($result){
                ...
                $_SESSION["SuccessMessage"] = "Thanks for supporting us!";
            }
            else{
...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
                                ...
                                <div class="fnc-slide__content">
                                    <h2 class="fnc-slide__heading">
                                        <div class="fnc-slide__heading-line">
                                            <span style="font-size: 80px">Cryjaxx</span>
                                        </div>
                                        <div class="fnc-slide__heading-line">
                                            <span style="font-size: 25px">DJ & Producer Duo</span>
                                        </div>
                                    </h2>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="weekly-news-area mb-50">
                            ...
                            <!-- Featured Post Area -->
                            <div class="featured-post-area bg-img bg-overlay mb-30" style="background-image: url(assets/img/cryjaxx10.jpg);">
                                <!-- Post Overlay -->
                                <div class="post-overlay">
                                    <div class="post-meta">
                                        <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> Cryjaxx</a>
                                        <a href="#"><i class="fa fa-file" aria-hidden="true"></i> Blog</a>
                                    </div>
                                    <a href="blog.php" class="post-title">Who would have thought!</a>
                                </div>
                            </div>
                            <div class="row">
                                <?php
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="razo-single-post d-flex mb-30">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="blog.php"><img src="upload/<?php echo $image; ?>" style="width: 100px; height: 100px" alt=""></a>
                                        </div>
                                        <!-- Post Content -->
                                        <div class="post-content">
                                            ...
                                            <a href="blog.php" class="post-title"><?php echo $title; ?></a>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="trending-news-area mb-50">
                            ...
                            <!-- Featured Post Area -->
                            <div class="featured-post-area small-featured-post bg-img bg-overlay mb-30" style="background-image: url(assets/img/cryjaxx_more.jpg);">
                                <!-- Post Overlay -->
                                <div class="post-overlay">
                                    <div class="post-meta">
                                        <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> Cryjaxx</a>
                                    ...
                                    <a href="single-podcast.html" class="post-title">She choose Us!</a>
                                </div>
                            </div>
                            <?php
                                global $connectingDB;
                                $sql= "SELECT * FROM musics m ORDER BY m.viewers desc limit 0, 4;";
                                $result = mysqli_query($connectingDB, $sql);
                                while ($DataRows = mysqli_fetch_array($result)) {
                                    $id        = $DataRows[0];
                            ...
                            <div class="razo-single-post d-flex mb-30">
                                <!-- Post Thumbnail -->
                                <div class="post-thumbnail">
                                    <a href="music.php"><img src="upload/<?php echo $image; ?>" alt=""></a>
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta">
                                    ...
                                    <a href="music.php" class="post-title"><?php echo $producers;?> - <?php echo $title; ?></a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
        ...
        <section class="razo-latest-news-area section-padding-80 bg-overlay bg-img jarallax" style="background-image: url(assets/img/cryjaxx_headphones.jpg);">
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-sm-6">
                        <div class="show-all-button mb-50 text-right">
                            <a href="music.php" class="btn show-all-btn">Show All Musics</a>
                        </div>
                    </div>
                </div>
            </div>
