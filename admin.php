...
<?php
    ...
    if (isset($_POST['edit_button'])){
        ...
        elseif (strlen($name_edit) < 3){
            ...
            if (!empty($username_edit) && !empty($name_edit) && !empty($email)) {
                $sql = "UPDATE admins 
                           SET date_time    = '$dateTime',
                               username     = '$username_edit',
                               first_name   = '$name_edit',
                               email        = '$email_edit'
...
<head>
    ...
    <title>Cryjaxx Admin | Admin </title>
...
<main>
    <section class="blog_area section-padding" style="padding-top: 50px!important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        <aside class="single_sidebar_widget search_widget" style="padding: 0!important;">
                            <div class="card">
                                <div class="profile grid-area">
                                    <div class="profile-data">
                                        <div class="data-details">
                                            <h3 style="color: #0C0613; font-weight: bold; text-align: center"><?php echo $username; ?></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <aside class="single_sidebar_widget newsletter_widget">
                            <a href="changepassword.php" style="color: #010E21; font-weight: bold; font-size: 14px"><button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn" type="submit">Change Password</button></a>
                        </aside>
                    </div>
                </div>
                                ...
                                <form action="admin.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <b>First Name:</b>
                                                <input type="text" id="first_name" name="name" class="form-control input-lg" placeholder="First Name" tabindex="1" value="<?php echo $name; ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 col-md-3">
                                            <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn" type="submit" name="edit_button"><i class="fas fa-check"></i> Save</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
