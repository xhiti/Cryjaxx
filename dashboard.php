...
<head>
    ...
    <title>Cryjaxx Admin | Dashboard </title>
        ...
        <div class="container">
                ...
                <div class="col-lg-4">
                    <div class="trending-news-area mb-50">
                        ...
                        <div class="section-heading" style="margin-bottom: 20px">
                            <h2 style="font-size: 24px">Latest Releases <i class="fa fa-music" aria-hidden="true"></i></h2>
                        </div>
                        <?php
                        global $connectingDB;
                        ...
                        ?>
                        <a href="admin-musics.php" style="color: #010E21"><button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn" type="submit">Add New Music <i class="fa fa-music"></i> </button></a>
                    </div>
                    <div class="box">
                        ...
                        <div class="box__body">
                            <div class="stats stats--main">
                                <div class="stats__amount"><i class="fab fa-youtube fa-3x icon-3d" style="font-size: 44px"></i> 16.8K</div>
                            ...
                            <div class="stats">
                                <div class="stats__amount"><i class="fab fa-spotify fa-3x icon-3d" style="font-size: 44px"></i> 275,837</div>
                                <div class="stats__caption">visitors/month</div>
                                <div class="stats__change">
                                    <div class="stats__value stats__value--negative">-3%</div>
                                    <div class="stats__period">this week</div>
                                </div>
                            </div>

                            <div class="stats">
                                <div class="stats__amount"><i class="fab fa-soundcloud fa-3x icon-3d" style="font-size: 44px"></i> 32.7K</div>
                                <div class="stats__caption">followers</div>
                                <div class="stats__change">
                                    <div class="stats__value--positive">+18%</div>
                                    <div class="stats__period">this week</div>
                                </div>
                            </div>
                            <div class="stats">
                                <div class="stats__amount">
                                    <img src="assets/img/cryjaxx_white_logo.png">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <article class="blog_item" style="padding: 20px; background-color: #f6faff">
                        <div class="blog-details">
                            <h3 style="font-weight: bold">Latest <span style="color: #27aae1">Posts</span></h3>
                            <div class="row razo-blog-masonary">
                                <?php
                                global $connectingDB;
                                $no_posts = 0;
                                $sql= "SELECT * FROM posts p ORDER BY p.id desc limit 0, 4;";
                                $result = mysqli_query($connectingDB, $sql);
                                ...
                                while ($DataRows = mysqli_fetch_array($result)) {
                                    ...
                                    <!-- Single Blog Item -->
                                    <div class="col-12 col-sm-6 col-lg-6 razo-blog-masonary-item mb-30">
                            ...
                            <a href="admin-posts.php"><button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn" type="submit">Add New Post</button></a>
                        </div>
                    </article>
                </div>
            </div>
            <section class="razo-latest-news-area bg-overlay bg-img jarallax" style="background-image: url(assets/img/cryjaxx_headphones.jpg);">
                ...
                <div class="razo-latest-news-slide owl-carousel">
                    <div class="razo-single-latest-news-area bg-overlay bg-img" style="background-image: url(assets/img/cryjaxx_rgr1.jpg);">
                        <!-- Post Content -->
                        <div class="post-content">
                            <a href="admin-tours.php" class="post-title">Rage of the Rampage</a>
                        </div>
                    </div>
                    <!-- Single Latest News Area -->
                    <div class="razo-single-latest-news-area bg-overlay bg-img" style="background-image: url(assets/img/cryjax_china_tour_img.jpg);">
                        <!-- Post Content -->
                        <div class="post-content">
                            <a href="admin-tours.php" class="post-title">China Tour 2019</a>
                        </div>
                    </div>
                    <!-- Single Latest News Area -->
                    <div class="razo-single-latest-news-area bg-overlay bg-img" style="background-image: url(assets/img/cryjaxx_colorday1.jpg);">
                        <!-- Post Content -->
                        <div class="post-content">
                            <a href="admin-tours.php" class="post-title">Colorday Festival</a>
                        </div>
                    </div>
                </div>
            </section>
