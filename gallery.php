...
<main>
    <section class="razo-latest-news-area bg-overlay bg-img jarallax" style="background-image: url(assets/img/cryjaxx_for_you.jpg); height: 400px;"></section>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 single_gallery_item <?php echo $category; ?> mb-30 wow fadeInUp" data-wow-delay="100ms">
                        <div class="single-portfolio-content">
                            ...
                            <div class="hover-content">
                                <a href="upload/<?php echo $image; ?>" class="portfolio-img">+</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
